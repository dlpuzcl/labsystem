					...
					<div class="panel-body">
						<form class="form-inline" action="${pageContext.request.contextPath }/lab/list.action"
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="roomCode" placeholder="房间号" value="${vo.roomCode }" name="roomCode">
							</div>
							...
							<a href="#" class="btn btn-success" data-toggle="modal"
							   ...
							   onclick="editUser(${row.room_id})">添加
							</a>
						</form>
					</div>
				</div>
											...
											<tr>
												...
												<td>
													<a href="#" class="btn btn-danger btn-xs"
													   onclick="deleteUser(${lab.room_id})">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" id="edit_lab_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control limited autosize-transition" id="edit_roomMemo" maxlength="50" name="room_memo"></textarea>
