								...
								请认写以下数据
													...
													<div class="panel-body">
														<div class="row">
															...
															<div class="col-xs-12">
																<!-- PAGE CONTENT BEGINS -->
																<form class="form-horizontal" id="myForm" action="${pageContext.request.contextPath }/updateUser">
																	...
																	<div class="form-group">
																		...
																		<div class="col-lg-5">
																			<div class="pos-rel">
																				<textarea class="form-control limited autosize-transition" id="usernote" maxlength="50" name="usernote">${user.usernote }</textarea>
																			</div>
																		</div>
																	</div>
