...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">设置课程性质</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                            ...
                            <div class=" col-md-12">
                                <div class="table-responsive">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover"
                                        ...
                                        <tbody>
                                        <c:forEach items="${course_nature}" var="row" varStatus="vs">
                                            <tr>
                                                <td>${vs.count }</td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="ModalLabel">添加课程性质</h4>
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal" id="add_Profession_form">
                            <input type="hidden" id="dict_type_code" name="dict_type_code" value="003"/>
                            <input type="hidden" id="dict_type_name" name="dict_type_name" value="课程性质"/>

                            <div class="form-group">
                                <label for="dict_item_name" class="col-sm-2 control-label">课程性质</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="dict_item_name" placeholder="课程性质"
                                           name="dict_item_name">
                                </div>
                            </div>
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.post("<%=basePath%>baseDict/delete.action", {"id": id}, function (data) {
                            if (data == "0") {
                                swal({title: "删除！", text: "已经被删除。", type: "success"},
                                    function () {
                                        window.location.reload();
                                    });
