															...
															<div class="col-xs-12">
																...
																<form class="form-horizontal" id="add_User_form">
																	...
																	<div class="form-group">
																		...
																		<div class="col-lg-5">
																			<input type="text" class="form-control" id="telephone" name="user_phone">
																		</div>
																	</div>
																	...
																	<div class="form-group">
																		...
																		<div class="col-lg-5">
																			<select class="form-control" id="professionalTitle" placeholder="职称" name="professional_title">
																				<option value="">--请选择--</option>
																	...
																	<div class="clearfix form-actions">
																		<div class="col-md-offset-3 col-md-9">
																			<button class="btn btn-primary" onclick="addUser()" type="submit">
