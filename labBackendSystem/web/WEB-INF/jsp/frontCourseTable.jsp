        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    $("#table_" + data[i].apply_day + "_" + data[i].apply_section).html("<div style='background-color: " + data[i].user_color + ";padding: 8px 8px;color: #FFFFFF;border-radius:8px;width: 106px;' >" + data[i].course_name +"-"+data[i].course_nature+ "<br>" + data[i].course_class + "<br>" + data[i].user_name +" " + data[i].course_memo+ "</div>");
                }
            }
        });
